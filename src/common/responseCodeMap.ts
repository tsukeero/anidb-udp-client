...
const CODE_TO_LABEL_MAP = reverseObj(RESPONSE_CODE)

export default CODE_TO_LABEL_MAP

export function getResponse (code: number | string): (typeof CODE_TO_LABEL_MAP)[keyof typeof CODE_TO_LABEL_MAP] | null {
  const numericCode = Number(code)
  if (numericCode in CODE_TO_LABEL_MAP) {
    return CODE_TO_LABEL_MAP[numericCode as keyof typeof CODE_TO_LABEL_MAP]
  } else {
    return null
  }
}
